  ...
  return (
    <main className={style.main}>
      <p className={style.confirmText}>
        ...
        <span className={style.bold}>{boOperation}</span>
      </p>
      ...
      <div className={style.infoDocument}>
        ...
        <p className={style.sender}>
          <span className={style.bold}>Отправитель:</span> {sender} / участок
          Цеха 01
        </p>
        <p className={style.taker}>
          <span className={style.bold}>Получатель:</span> {taker} / участок Цеха
          02
        </p>
      </div>
